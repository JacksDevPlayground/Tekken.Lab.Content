...
(https://www.bandainamcoent.eu/tekken/tekken-8)") Patch 1.01.04 is here, fighters! This patch will have an impact on the following modes & features due to gameplay adjustments for some characters.   The application of the update data will impact the following modes and features due to the changes brought to characters:\
&#x20; &#x20;
